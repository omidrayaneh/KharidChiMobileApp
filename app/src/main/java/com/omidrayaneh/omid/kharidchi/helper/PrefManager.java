...
public class PrefManager {
    ...
    private static final String PREF_NAME = "MY_PREFS_NAME";
    ...
    public void createLogin(String name, String family, String mobile) {
       ...
       /* MainActivity mainActivity = new MainActivity();
        mainActivity.navMobile.setText(name + " " + family);
        mainActivity.navMobile.setText(mobile);*/
    }
    ...
    public HashMap<String, String> getUserDetails() {
        ...
        profile.put("family", pref.getString(KEY_FAMILY, null));
